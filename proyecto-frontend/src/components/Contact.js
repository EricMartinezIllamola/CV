            ...
            <div className="form_box" id="form_box">
                ...
                <form name="formulario" action="confirmation.php" method="post" onsubmit="return validation()">
                    <div className="input_box">
                        ...
                        <label for="nombre" className={nombre_up ? "label_up" : ""}>Nombre</label>
                    ...
                    <div className="input_box">
                        ...
                        <label for="email" className={email_up ? "label_up" : ""}>Email</label>
                    ...
                    <div className="input_box">
                        ...
                        <label for="motivo" className={motivo_up ? "label_up" : ""}>Motivo</label>
                    ...
                    <div className="input_box">
                        ...
                        <label for="mensaje" className={mensaje_up ? "label_up" : ""}>Mensaje</label>
