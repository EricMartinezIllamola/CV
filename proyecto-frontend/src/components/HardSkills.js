        ...
        <section id="HardSkills">
                <div className="container-fluid">
                    <div className="row">
                        ...
                        <div className="col-12 span">Explotación de Datos:</div>
                    ...
                    <div className="row">
                        <div className="col-12 span">Bases de Datos:</div>
                    ...
                    <div className="row">
                        <div className="col-12 span">Frontend:</div>
                    ...
                    <div className="row">
                        <div className="col-12 span">Big Data, Cloud y GitHub:</div>
